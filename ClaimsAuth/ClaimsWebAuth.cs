...
namespace MSDN.Samples.ClaimsAuth
{
    ...
    public class ClaimsWebAuth : IDisposable
    {
        ...
        public CookieCollection Show()
        {
            ...
            DisplayLoginForm.StartPosition = FormStartPosition.Manual;
            DisplayLoginForm.Location = new Point(Screen.PrimaryScreen.WorkingArea.Width - DisplayLoginForm.Width,
                                    Screen.PrimaryScreen.WorkingArea.Height - DisplayLoginForm.Height);
            ...
            DisplayLoginForm.WindowState = FormWindowState.Minimized;
